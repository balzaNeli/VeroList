...
Projeto desenvolvido acompanhando a playlist:

> [Android com Compose e MVVM — YouTube](https://www.youtube.com/watch?v=DErI7VR992g&list=PLPs3nlHFeKTp6tQwIuUoC248VL2aDwbqW)
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/seu-usuario/vero.git
   ```
